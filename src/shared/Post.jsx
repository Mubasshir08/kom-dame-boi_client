  ...
  return (
    <div className={`${IsPopUpShow ? "block" : "hidden"} w-2/3 md:w-1/2 pt-4 md:pt-2 absolute bg-base-100 border border-neutral z-10 rounded-md translate-x-20 md:translate-x-77`}>
      <form action="" className='md:px-3 relative'>
        ...
        <div className='relative border border-dotted w-7/8 ml-5.5 md:ml-10 my-3 md:p-1 md:h-50'>
        <textarea name="" id="" className='resize-none border-none focus:outline-none w-full h-37 overflow-scroll' placeholder='Description ...'></textarea>
        <GrAttachment className='absolute bottom-2 left-3 text-lg cursor-pointer'/>
        </div>
